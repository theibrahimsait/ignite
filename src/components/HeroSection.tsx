...
export const HeroSection = ({
  ...
  return <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="absolute bottom-2 sm:bottom-4 left-1/2 transform -translate-x-1/2 my-[150px]">
        <div className="w-6 h-10 border-2 border-primary/30 rounded-full flex justify-center py-0 my-0">
